...
fixedtest_step <- function (sims,delta.t,S,E,I1,I2,I3,I4,A,R,H,
                            WI1, WI2, WI3, WI4, WA,
                            TI1,TI2,TI3,TI4,TA,N,D,
                            d,beta,theta,p,q,gamma_I1I2,gamma_I2R,
                            gamma_AR,gamma_I4H, gamma_HTR,gamma_HD,rho, 
  ...
  ret = cbind(S,E,I1,I2,I3,I4,A,R,H,WI1,WI2,WI3,WI4,WA,
              TI1,TI2,TI3,TI4,TA,D,N,new_cases,new_hosp, num.symp.test, new_sympiso = test.symp[,1] + test.symp[,2], new_asympiso = (dN_WI1TI1+dN_WI3TI3+dN_WATA)) 
