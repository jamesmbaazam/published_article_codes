...
dt    <- seq(0,61,0.1)      # set the time points for evaluation
...
q<-cbind(out$I2+out$I3)
r<-cbind(out$S2+out$I1+out$I2+out$I3)
w<-cbind(q/r)*270287
...
write.xlsx(w, "C:/Users/oresths/Desktop/wasted.xlsx")