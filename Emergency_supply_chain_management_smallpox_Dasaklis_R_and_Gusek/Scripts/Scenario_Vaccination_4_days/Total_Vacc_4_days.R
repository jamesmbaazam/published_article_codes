...
matplot(x = Total_Infected[,1], y = Total_Infected[,-1], type = "l", lwd = 2,
        ...
        xlab = "time (days)", ylab = "Infected individuals", main = "First set of scenarios")
