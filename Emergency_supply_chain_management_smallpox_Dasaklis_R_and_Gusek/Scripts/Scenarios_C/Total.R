...
SEIR <- function(t, x, parms){
  ...
  with(as.list(c(parms,x)),{
    Inv <-   ifelse(t<22,Inv,277300)
    Inv <-   ifelse(t<27,Inv,114689)
    Inv <-   ifelse(t<28,Inv,0)
    Inv <-   ifelse(t<31,Inv,277300)
    Inv <-   ifelse(t<39,Inv,33384)
    Inv <-   ifelse(t<40,Inv,0)
    dS2 <- - b*S2*I3
...
SEIR <- function(t, x, parms){
  ...
  with(as.list(c(parms,x)),{
    Inv <-   ifelse(t<29,Inv,277300)
    Inv <-   ifelse(t<34,Inv,114689)
    Inv <-   ifelse(t<35,Inv,0)
    Inv <-   ifelse(t<38,Inv,277300)
    Inv <-   ifelse(t<46,Inv,33384)
    Inv <-   ifelse(t<47,Inv,0)
    dS2 <- - b*S2*I3
    dS3 <- - b*S3*I3-Inv*S3/(S3+I1+I2+I3)
    dI1 <-   b*S3*I3+b*S2*I3-r1*I1-Inv*I1/(S3+I1+I2+I3)
    dI2 <-   r1*I1-r2*I2
...
SEIR <- function(t, x, parms){
  ...
  with(as.list(c(parms,x)),{
    Inv <-   ifelse(t<36,Inv,277300)
    Inv <-   ifelse(t<41,Inv,114689)
    Inv <-   ifelse(t<42,Inv,0)
    Inv <-   ifelse(t<45,Inv,277300)
    Inv <-   ifelse(t<53,Inv,33384)
    Inv <-   ifelse(t<54,Inv,0)
    dS2 <- - b*S2*I3
    dS3 <- - b*S3*I3-Inv*S3/(S3+I1+I2+I3)
    dI1 <-   b*S3*I3+b*S2*I3-r1*I1-Inv*I1/(S3+I1+I2+I3)
    dI2 <-   r1*I1-r2*I2
...
SEIR <- function(t, x, parms){
  ...
  with(as.list(c(parms,x)),{
    Inv <-   ifelse(t<43,Inv,277300)
    Inv <-   ifelse(t<48,Inv,114689)
    Inv <-   ifelse(t<49,Inv,0)
    Inv <-   ifelse(t<52,Inv,277300)
    Inv <-   ifelse(t<60,Inv,33384)
    Inv <-   ifelse(t<61,Inv,0)
    dS2 <- - b*S2*I3
    dS3 <- - b*S3*I3-Inv*S3/(S3+I1+I2+I3)
    dI1 <-   b*S3*I3+b*S2*I3-r1*I1-Inv*I1/(S3+I1+I2+I3)
    dI2 <-   r1*I1-r2*I2
...
SEIR <- function(t, x, parms){
  ...
  with(as.list(c(parms,x)),{
    ...
    Inv <-   ifelse(t<55,Inv,114689)
    Inv <-   ifelse(t<56,Inv,0)
    Inv <-   ifelse(t<59,Inv,277300)
    Inv <-   ifelse(t<67,Inv,33384)
    Inv <-   ifelse(t<68,Inv,0)
    dS2 <- - b*S2*I3
    dS3 <- - b*S3*I3-Inv*S3/(S3+I1+I2+I3)
    dI1 <-   b*S3*I3+b*S2*I3-r1*I1-Inv*I1/(S3+I1+I2+I3)
    dI2 <-   r1*I1-r2*I2
...
matplot(x = Total_Infected[,1], y = Total_Infected[,-1], type = "l", lwd = 2,
        ...
        xlab = "time (days)", ylab = "Infected individuals", main = "Third set of scenarios")
